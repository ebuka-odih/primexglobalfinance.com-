                                ...
                                <div id="collapseCash" class="collapse show" aria-labelledby="headingCash" data-parent="#accordion">
                                    <div class="card-body bg-dark shadow">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="btccash_address" value="" class="form-control text-light bg-dark" placeholder="Enter Bitcoin Cash Address">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="collapseFive" class="collapse show" aria-labelledby="headingFive" data-parent="#accordion">
                                    <div class="card-body bg-dark shadow">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tron_address" value="" class="form-control text-light bg-dark" placeholder="Enter Tron Address">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="collapseSix" class="collapse show" aria-labelledby="headingSix" data-parent="#accordion">
                                    <div class="card-body bg-dark shadow">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="usdt_address" value="" class="form-control text-light bg-dark" placeholder="Enter USDT Address">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="collapseEight" class="collapse show" aria-labelledby="headingEight" data-parent="#accordion">
                                    <div class="card-body bg-dark shadow">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bnb_address" value="" class="form-control text-light bg-dark" placeholder="Enter bnb Address">
                                        </div>
                                    </div>
                                </div>
                            </div>
