                    ...
                    <form method="POST" action="{{ route('register') }}" class="mt-5 card__form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="password" class="form-control" name="password_confirmation" value="" id="confirm-password" placeholder="Confirm Password">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="text-center mb-3">
                            <small class=" text-center mb-2">Already have an Account  <a href="login">Login.</a> </small>
...
<!-- Mirrored from www.ftfinancetraders.com/register by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Sep 2022 04:25:19 GMT -->
</html>
